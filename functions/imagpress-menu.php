...
$box_array[] = array( 'id' => 'fancybox', 'title' => ''.$image.__("Enable Fancy Box On Blog Post Images", THEME_NAME), 'page' => 'post', 'context' => 'normal', 'priority' => 'high', 'fields' => array(array('name' => __("Fancybox:", THEME_NAME), 'std' => '', 'id' => $prefix. 'fancybox', 'type'=> 'off_on' ) ), 'size' => 10,'first' => 'no'  );
...
$box_array[] = array( 'id' => 'main-slider-post', 'title' => ''.$image.__("Main Slider Post", THEME_NAME), 'page' => 'post', 'context' => 'normal', 'priority' => 'high', 'fields' => array(array('name' => __("Show", THEME_NAME), 'std' => '', 'id' => $prefix. 'main_slider', 'type'=> 'yes_no' ) ), 'size' => 10,'first' => 'no'  );
